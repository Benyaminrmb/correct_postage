@component('admin.layouts.content' , ['title' => 'لیست سفارشات'])
    ...
    <script>
        ...
        var map2 = L.map('map2').setView([originLatAddress.value,originLongAddress.value ], 16);
        L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
            attribution: '&copy; <a href="https://osm.org/copyright">OpenStreetMap</a> contributors'
        }).addTo(map2);

        L.marker([originLatAddress.value,originLongAddress.value ]).addTo(map2)



        var map = L.map('map').setView([destinationLatAddress.value,destinationLongAddress.value ], 16);
        L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
            attribution: '&copy; <a href="https://osm.org/copyright">OpenStreetMap</a> contributors'
        }).addTo(map);

        L.marker([destinationLatAddress.value,destinationLongAddress.value ]).addTo(map)
